      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Your productivity hub</p>
          </div>
        </motion.div>
        ...
        >
          <button
            ...
            className="p-2 rounded-lg bg-dark-card border border-dark-border hover:border-gold transition-colors duration-200"
          >
            {isDarkMode ? (
